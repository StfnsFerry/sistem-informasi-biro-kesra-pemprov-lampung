                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        ?>
                            ...
                            <?php else: ?>
                            <a href="/tahfidzul-quran/ubah-biodata" class="btn btn-primary shadow-sm">Ubah Data</a>  
                            <?php endif?>                 
                        <?php else : ?>
                            <a href="/tahfidzul-quran/tambah-biodata" class="btn btn-primary shadow-sm">Tambah Data</a>  
                        <?php endif;?> 
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body"> 
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php if($biodata != NULL) : ?>
                                            <h6 class="font-weight-bold text-dark"><?= $biodata[0]['kategori_juz']?></h6>
                                        <?php else : ?>
                                            <h6 class="font-weight-bold text-dark">-</h6>
                                        <?php endif;?>
                                    </div>
