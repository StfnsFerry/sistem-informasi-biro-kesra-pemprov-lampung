                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                                        5 Juz</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_limajuz?> Orang</div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                        10 Juz</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_sepuluhjuz?> Orang</div>
                                    <a href="/admin/tahfidzul-quran/sepuluh-juz" class="text-xs mb-0 fw-500 text-dark">Lihat selengkapnya</a>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        20 Juz</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_duapuluhjuz?> Orang</div>
                                    <a href="/admin/tahfidzul-quran/duapuluh-juz" class="text-xs mb-0 fw-500 text-dark">Lihat selengkapnya</a>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                        30 Juz</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_tigapuluhjuz?> Orang</div>
                                    <a href="/admin/tahfidzul-quran/tigapuluh-juz" class="text-xs mb-0 fw-500 text-dark">Lihat selengkapnya</a>
                                </div>
                                <div class="col-auto">
        ...
        <div class="col-lg-12 mb-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">List Seluruh Penerima Hibah Tokoh Agama</h6>
                    <div class="button-header"></div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="exportDataTahfidzul" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Nama</th>
