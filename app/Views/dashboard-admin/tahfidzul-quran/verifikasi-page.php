...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Verifikasi Pendaftar Program Hibah Hafidz dan Hafidzah</h1>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <form action="<?= base_url('/admin/tahfidzul-quran/updateVerifikasi')?>" method="POST">
