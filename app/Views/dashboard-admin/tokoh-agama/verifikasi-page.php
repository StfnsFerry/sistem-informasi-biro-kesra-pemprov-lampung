        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <embed src="<?= base_url('')?>" width="100%" height="500" type="application/pdf">
                </div>
        ...
        <div class="col-lg-6 mb-4">
            <form action="<?= base_url('/admin/tokoh-agama/updateVerifikasi')?>" method="POST">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="permohonan_pamong" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="permohonan_pamong" id="inlineRadio1">
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="susunan_pengurus" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="susunan_pengurus" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tidak Ada</label>
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="rab" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="rab" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tidak Ada</label>
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="foto_bangunan" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="foto_bangunan" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tidak Ada</label>
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="izin_operasional" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="izin_operasional" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tidak Ada</label>
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="ktp" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="ktp" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tidak Ada</label>
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="fc_rekening" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="fc_rekening" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tidak Ada</label>
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="npwp" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="npwp" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tidak Ada</label>
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="stempel" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="stempel" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tidak Ada</label>
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="surat_keterangan_domisili" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="surat_keterangan_domisili" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tidak Ada</label>
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Ada" name="lain_lain" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Ada</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" value="Tidak Ada" name="lain_lain" id="inlineRadio1">
                                    <label class="form-check-label" for="inlineCheckbox1">Tidak Ada</label>
                                </div>
                ...
                <div class="card-body d-flex justify-content-end">
                    ...
                    <input type="hidden" name="id_pemeriksa" value="">
