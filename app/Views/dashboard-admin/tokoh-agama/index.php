                        ...
                        <div class="card-body">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <a href="/admin/tokoh-agama/pendaftar" class="text-xs mb-0 fw-500 text-dark">Lihat selengkapnya</a>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                        Guru Ngaji</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_gurungaji?> Orang</div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        Imam Masjid</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_imammasjid?> Orang</div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                                        Marbot</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_marbot?> Orang</div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="exportDataTokohAgama" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Nama</th>
